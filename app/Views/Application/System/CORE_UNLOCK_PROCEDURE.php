                            ...
                            <div class="col-lg-12 col-xl-12 offset-xl-0">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-2" style="color: var(--bs-danger);">ATTENTION</h4>
                                        <p class="mb-4">Vous Etes Sur Le Point de Lancer Un <strong>Déverrouillage du Cœur</strong> de L'Application</p>
                                        <hr>
